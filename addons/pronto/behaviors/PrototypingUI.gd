...
func create_ui_for_advanced_value_enum(value: AdvancedValue):
	...
	optionButton.item_selected.connect(handle_advanced_value_enum_change.bind(value,optionButton))
	
	var reset_button = Button.new()
	reset_button.text = "R"
	reset_button.focus_mode = 0
	reset_button.button_down.connect(handle_advanced_value_enum_change.bind(value.enum_default_index, value, optionButton))
...
func create_ui_for_advanced_value_bool(value: AdvancedValue):
	...
	optionButton.item_selected.connect(handle_advanced_value_bool_change.bind(value, optionButton))
	...
	if value.bool_value == "TRUE":
		...
		reset_index = 0
	reset_button.button_down.connect(handle_advanced_value_bool_change.bind(reset_index, value, optionButton))
...
func create_ui_slider_for_advanced_value_float(value: AdvancedValue):
	...
	hslider.value_changed.connect(handle_slider_update_advanced_value_float_change.bind(value,label_current, hslider))
	# fancy ui signals
	...
	reset_button.text = "R"
	reset_button.focus_mode = 0
	reset_button.button_down.connect(handle_slider_update_advanced_value_float_change.bind(value.float_default,value,label_current,hslider))
...
func handle_advanced_value_bool_change(index: int, value: AdvancedValue, optionButton : OptionButton):
	optionButton.select(index)
	value.bool_value = optionButton.get_item_text(index)
	
func handle_advanced_value_enum_change(index: int, value: AdvancedValue, optionButton: OptionButton):
	optionButton.select(index)
	value.enum_value = value.enum_choices[index]
	
func handle_slider_update_advanced_value_float_change(new_value: float, value: AdvancedValue, label_current: Label, slider :HSlider):
...
func _at_least_one_valid_child():
	for childNode in self.get_children():
		if is_instance_of(childNode, Value) or is_instance_of(childNode, AdvancedValue):
			return true
	return false
